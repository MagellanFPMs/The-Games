#!/bin/sh
# 
# Install script for game servers of The-games.be pour CentOS 6
...
function repos() # étape 1
{
	...
	echo -en "\n### Fish ###\n"
	yum -y install wget
	wget -O /etc/yum.repos.d/shells:fish:release:2.repo http://download.opensuse.org/repositories/shells:fish:release:2/CentOS_6/shells:fish:release:2.repo
...
function config()
{
	...
	echo -en "\n"
	echo -en "\n### SELINUX ###\n"
	wget -O /etc/seliman nux/config http://www.magellan.fpms.ac.be/cfg-sv/selinux.config
